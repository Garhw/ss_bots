...
API_ID = int(environ.get('API_ID', '27583102'))
API_HASH = environ.get('API_HASH', '577aab09bea0e487a4e3ee577b085c85')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/gSw.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6819595097').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6819595097').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002316014955'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002473524927').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002491401117') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shubham5613aa:n5pV9DTrIVZfD6Fq@cluster0.9myuv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://shubham5613aa:n5pV9DTrIVZfD6Fq@cluster0.9myuv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://habibahsan019464:HzK6LocEqhFpA972@cluster0.aq6j0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://digvijaythakur629:siKSoYC7QR3GqGxZ@cluster0.uznwi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Ssmovies_latest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/SS_MoviesChannel')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'membr_adder') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/boss_5613')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '4adb2ba8f7b0ad1f295f4278f5a756b8f5e9dcab')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/SS_MoviesChannel/2') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
